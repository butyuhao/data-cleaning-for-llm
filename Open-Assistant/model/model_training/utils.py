...
def get_model(conf, tokenizer, pad_vocab_size_to_multiple_of=16, train_word_embedding_only=False):
    dtype = torch.float32
    ...
    print("Number of trainable parameters: {}".format(int(params)))

    if not train_word_embedding_only:
        patch_model(
            model,
