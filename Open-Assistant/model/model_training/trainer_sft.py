...
def argument_parsing(notebook=False, notebook_args=None):
    ...
    conf["local_rank"] = int(os.getenv("LOCAL_RANK", default=-1))
...
def main():
    ...
    ic(training_conf.gradient_accumulation_steps)
    ic(training_conf.per_device_train_batch_size)
    ic(training_conf.per_device_eval_batch_size)
    ...
    args = TrainingArguments(
        ...
        logging_dir=training_conf.log_dir,
        ddp_timeout=99999
    )
