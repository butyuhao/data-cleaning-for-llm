...
from model_training.custom_datasets.instruction import INSTRUCTION_DATASETS, InstructionDataset, MY_INSTRUCTION_DATASETS
...
My_Dialogues = {    
    "old_chatglm_belle_dialog": "/data/ecnu/data/old_Chatglm_data/old_chatglm_BELLE_dialog.json",
    "_belle_dialog": "/data/ecnu/data/normal_quality/opensource_data/BELLE_dialog.jsonl",
    "_coig_multi_turn": "/data/ecnu/data/normal_quality/opensource_data/COIG_multi_turn.jsonl",
    "_emotion_dialog": "/data/ecnu/data/normal_quality/zeroshot_data/emotion_dialog.jsonl"
}
...
def get_one_dataset(
    ...
    **kwargs,
    ...
    if dataset_name in My_Dialogues:
